...
try {
  await ffmpeg(["-f", "lavfi", "-i", `color=c=0x202631:s=1920x1080:r=${fps}`, "-f", "lavfi", "-i", "anullsrc=channel_layout=stereo:sample_rate=48000", "-vf", draw, "-t", String(duration), "-map", "0:v:0", "-map", "1:a:0", "-c:v", "libx264", "-c:a", "aac", "-b:a", "128k", "-shortest", "-pix_fmt", "yuv420p", "-movflags", "+faststart", mp4]);
